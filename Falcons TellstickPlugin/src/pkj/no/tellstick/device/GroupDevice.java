 ...
 * A Device group can contain many actions such as Bell, Dim and etc. 
 * 
 * 
 ...
 * 			// Device instance. (On / Off accepted )
 * 		}
 * }
 * @author peec
 *
...
public class GroupDevice extends TellstickDevice implements Pluggable{
	...
	/**
	 * Can be used such as:
	 * this.hasDevice(Device.class, DimmableDevice.class, BellDevice.class, ... )
