...
public abstract class AbstractPluginData {
	 ...
	 * @param methodID The ID of the method inside the Plugin that's going to be used.
	 * @param versionID The ID of the version of the Plugin.
	 */
	...
	/**
	 * 
	 * @return Returns the ID of the version of the plugin that sent the data object.
	 */
