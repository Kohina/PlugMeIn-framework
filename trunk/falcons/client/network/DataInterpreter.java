...
public class DataInterpreter {
	...
	/**
	 * The Constructor for the DataInterpreter. Takes a pluginModel as a parameter.
	...
	/**
	 * Interpret where the PluginCall is supposed to be sent and then send it to the corresponding Plugin.
