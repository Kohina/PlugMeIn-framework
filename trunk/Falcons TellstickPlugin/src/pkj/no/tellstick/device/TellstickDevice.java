...
public class TellstickDevice implements Comparable<TellstickDevice>{
	 ...
	 * @param TS
	 * @param deviceId
	 * @return TellstickDevice , Either BellDevice, DimmableDevice or Device.
	 ...
	 * Usage:
	 * ArrayList<TellstickDevice> devices2 = TellstickDevice.getDevices(Device.class, DimmableDevice.class, ...etc...);
	 * @param type
	 * @return
	 * @throws SupportedMethodsException
	 */
	 ...
	 * Usage:
	 * ArrayList<TellstickDevice> devices2 = TellstickDevice.getDevices(devices, Device.class, DimmableDevice.class, ...etc...);
	 * @param allDevices ArrayList of devices for input.
	 * @param type The types , eg DimmableDevice.class , Device.class, BellDevice.class, GroupDevice.class ... etc ..
	 * @return
	 * @throws SupportedMethodsException
	 */
